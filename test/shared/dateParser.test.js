...
describe('DateParser', function() {
  describe('monthStringToInt', function() {
    ...
    it('should find values for valid month 3 char abbreviations', function() {
      const opts = {
        objectValidator: {
          isString: (val) => true,
        },
    ...
    it('should not find values for null or undefined', function() {
      const opts = {
        objectValidator: {
          isString: (val) => false,
        },
  ...
  describe('intMonthToYear', function() {
    ...
    it('should fail to find months that dont exist', function() {
      const opts = {
        objectValidator: {
          isNumber: (val) => true,
        },
